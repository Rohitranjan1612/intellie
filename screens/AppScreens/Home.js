...
const HomeScreen = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      <View
        style={{backgroundColor: 'white', width: '100%', height: 35}}></View>
      {/* Content */}
      <ScrollView contentContainerStyle={styles.MainWrap}>
        ...
        <View style={styles.searchContainer}>
          <View
            ...
            <TextInput
              ...
              style={{height: 30, fontSize: 18, width: '100%'}}
            />
          </View>
        ...
        <View style={{marginBottom: 45}}>
          <Text style={{color: '#6B4EFF', fontWeight: '600', fontSize: 24}}>
            Current Update
          </Text>
          <ScrollView
            horizontal
            ...
            <LinearGradient
              ...
              <Image
                source={require('../../assets/Start/pose1.png')}
                style={{
                  position: 'absolute',
                  width: 100,
                  height: 150,
            ...
            <LinearGradient
              ...
              <View style={{width: CARD_WIDTH * 0.5}}>
                <Text
                  style={{fontSize: 13, fontWeight: 'bold', color: '#2A0087'}}>
                  Upcoming Session
                </Text>
                <Text
                  style={{
                ...
                <View style={{flexDirection: 'row', gap: 5}}>
                  <Text style={{fontSize: 14, color: '#2A0087', marginTop: 5}}>
                    Lecture by
                  </Text>
                  <Text
                    style={{
            ...
            {filterCards().map((card, index) => (
              <LinearGradient
                ...
                <Text style={{color: 'white', fontSize: 14}}>
                  Lecture by Sahil Verma
                </Text>
                <Image
                  source={require('../../assets/DashBoard/Rectangle.png')}
                  style={{
                    position: 'absolute',
                    width: 100,
                    height: 150,
