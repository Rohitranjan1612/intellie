      ...
      <ScrollView contentContainerStyle={styles.MainWrap}>
        ...
        <View>
          ...
          <View style={{ marginTop: 20 }}>
            ...
            <TouchableOpacity onPress={()=>navigation.navigate('PaymentHistory')} style={styles.navBtn}>
              <View style={{ width: '80%', flexDirection: 'row', gap: 10 }}>
                <Icon name={'wallet-outline'} color={'black'} size={20} />
            ...
            <TouchableOpacity onPress={() => setModalVisible(true)} style={styles.navBtn}>
              <View style={{ width: '80%', flexDirection: 'row', gap: 10 }}>
                <Icon name={'ribbon-outline'} color={'black'} size={20} />
        ...
        <TouchableOpacity style={styles.navBtn}>
          <View style={{ width: '80%', flexDirection: 'row', gap: 10 }}>
            <Icon name={'power-outline'} color={'black'} size={20} />
