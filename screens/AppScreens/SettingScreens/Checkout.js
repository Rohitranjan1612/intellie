                ...
                <View style={{ marginVertical: 20 }}>
                        ...
                        <View style={styles.detailsContainer}>
                            ...
                            >
                                <View style={{ width: '80%', flexDirection: 'row', gap: 10, alignItems: 'center' }}>
                                    <IconFontAwesome name={'cc-mastercard'} color={'black'} size={20} />
                            ...
                            >
                                <View style={{ width: '80%', flexDirection: 'row', gap: 10, alignItems: 'center' }}>
                                    <IconFontAwesome name={'cc-visa'} color={'black'} size={20} />
                            ...
                            <TouchableOpacity style={{ flexDirection: 'row', gap: 10, alignItems: 'center' }}>
                                <View style={{ backgroundColor: '#6B4EFF', borderRadius: 7, width: 30, height: 30, alignItems: 'center', justifyContent: 'center' }}>
                                    <IconFontAwesome5 name={'plus'} size={16} color={'white'} />
                                </View>
                    ...
                    <View style={{ marginVertical: 20 }}>
                        ...
                        <View style={styles.detailsContainer}>
                            ...
                            >
                                <View style={{ width: '80%', flexDirection: 'row', gap: 10, alignItems: 'center' }}>
                                    <IconFontAwesome5 name={'google-pay'} color={'black'} size={20} />
                            ...
                            >
                                <View style={{ width: '80%', flexDirection: 'row', gap: 10, alignItems: 'center' }}>
                                    <IconFontAwesome5 name={'paypal'} color={'black'} size={20} />
                            ...
                            >
                                <View style={{ width: '80%', flexDirection: 'row', gap: 10, alignItems: 'center' }}>
                                    <IconFontAwesome name={'bank'} color={'black'} size={20} />
                    ...
                    <View style={styles.detailsContainer}>
                        ...
                        >
                            ...
                            <View style={{ width: '20%', alignItems: 'flex-end' }}>
                                <IconIonicons name={'chevron-forward-outline'} size={20} />
                            </View>
                        </TouchableOpacity>
                    </View>

                    <View style={{backgroundColor:'lightblue',paddingHorizontal:40,paddingTop:20,paddingBottom:40,margin:-15,marginTop:20,marginBottom:40,flexDirection:'row',justifyContent:'space-between',alignItems:'center'}}>
                        <View>
                            <Text style={{color:'#6B4EFF',fontSize:22,fontWeight:'bold'}}>999 Rs</Text>
                            <Text>view detailed bill</Text>
                        </View>
                        <TouchableOpacity style={{backgroundColor:'#6B4EFF',paddingHorizontal:20,paddingVertical:15,borderRadius:15}}>
