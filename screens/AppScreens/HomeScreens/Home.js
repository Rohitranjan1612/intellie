      ...
      <ScrollView contentContainerStyle={styles.MainWrap}>
        ...
        <View style={{ flex: 1, flexDirection: 'row' }}>
          <View style={{ flexDirection: 'row', gap: 20 }}>
            ...
            >
              <IconAntDesign name={'user'} size={36} color={'#FFFFFF'} />
            </LinearGradient>
          ...
          <View style={{ flexDirection: 'row', flex: 1, justifyContent: 'flex-end', alignItems: 'center', gap: 20 }}>
            <TouchableOpacity>
              <IconIonicons name={'notifications-outline'} color={'black'} size={28} />
              <View style={{ position: 'absolute', top: 1, right: 1, width: 6, height: 6, backgroundColor: 'red', borderRadius: 10 }}></View>
            </TouchableOpacity>
            <TouchableOpacity>
              <IconIonicons name={'bookmark-outline'} color={'black'} size={28} />
            </TouchableOpacity>
          </View>
        </View>
        {/* Search Bar */}
        <View style={styles.searchContainer}>
          <View style={{ flexDirection: 'row', gap: 10, alignItems: 'center', width: '80%' }}>
            <IconIonicons name={'search-outline'} color={'#8E8E8E'} size={24} />
            <TextInput placeholder='Search' placeholderTextColor={'#8E8E8E'} style={{ height: 40, fontSize: 18, width: '100%' }} />
          </View>
          <View style={{ alignItems: 'flex-end', width: '20%' }}>
            <IconIonicons name={'filter-outline'} color={'black'} size={28} />
          </View>
        </View>
        ...
        <View style={{ marginBottom: 20 }}>
          ...
          <View>
            <TouchableOpacity onPress={() => navigation.navigate('Examinations')} style={{width:'100%',backgroundColor:'lightgray',padding:15,borderRadius:10}}>
              <Text style={{color:'#1c2b49',fontSize:20,textAlign:'center',fontWeight:'600'}}>Start Quiz</Text>
            </TouchableOpacity>
          </View>
        </View>
      </ScrollView>
