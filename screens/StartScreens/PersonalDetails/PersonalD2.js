  ...
  const expOptions = [
    {
      id: 'beginner',
      text: 'Beginner',
      description: 'Start your journey from scratch.',
    },
    {
      id: 'intermediate',
      text: 'Intermediate',
      description: 'Answer a few questions to find your experience.',
    },
  ];
      ...
      <ScrollView contentContainerStyle={styles.MainWrap}>
        ...
        <View style={{marginTop: 60, width: '90%', alignSelf: 'center'}}>
          ...
          <View style={{marginTop: 40, padding: 20}}>
            <View>
              <Text style={styles.headerText}>Personalize</Text>
              ...
              <View style={{width: '100%', flexDirection: 'row', gap: 10}}>
                <TouchableOpacity
                  ...
                  <Text
                    style={{
                      textAlign: 'center',
                      color: selectedGoal === 'Daily' ? 'white' : 'black',
                    }}>
                    Daily
                  </Text>
                </TouchableOpacity>
                <TouchableOpacity
                  ...
                  <Text
                    style={{
                      textAlign: 'center',
                      color: selectedGoal === 'Weekly' ? 'white' : 'black',
                    }}>
                    Weekly
                  </Text>
                </TouchableOpacity>
                  ...
                  <View style={{width: '100%', flexDirection: 'row', gap: 10}}>
                    {expOptions.map(expOption => (
                      <TouchableOpacity
                        ...
                        onPress={() =>
                          handleExpOptionSelect(subject, expOption.id)
                        }>
                        <Text
                          style={[
                            styles.expBtnHead,
                            subjectExpOptions[subject] === expOption.id
                              ? styles.selectedExpHeadOption
                              : null,
                          ]}>
                          {expOption.text}
                        </Text>
                        <Text style={styles.expBtnPara}>
                          {expOption.description}
                        </Text>
                        {subjectExpOptions[subject] === expOption.id && (
